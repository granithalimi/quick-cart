...
export default function Footer() {
  ...
  return (
    <>
      <button onClick={() => handleClick()} className={`${scrolledDown ? "block show-arrow" : "hide-arrow"} fixed p-5 rounded-full bg-white shadow-black/20 shadow-lg bottom-5 right-5`}>
